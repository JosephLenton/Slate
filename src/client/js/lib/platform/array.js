...
(function() {
     ...
     */
    Array.prototype.filterOutMethod = function( meth ) {
        var fun;
     ...
     */
    Array.prototype.filterMethod = function( meth ) {
        var fun;
        if ( arguments.length > 1 ) {
            var args = new Array( arguments.length-1 );
            for ( var i = 1; i < arguments.length; i++ ) {
     ...
     */
    Array.prototype.filterOutType = function( proto, thisObj ) {
        if ( arguments.length > 1 ) {
     ...
     */
    Array.prototype.filterType = function( proto, thisObj, keepProto ) {
        var hasThis = false;
